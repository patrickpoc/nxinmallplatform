  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary: "border-transparent bg-surface-mid text-brand-dark",
        success: "border-transparent bg-success-surface text-success",
        warning: "border-transparent bg-warning-surface text-warning",
        destructive: "border-transparent bg-error-surface text-error",
        outline: "text-brand-dark border-border",
      },
    },
    defaultVariants: {
      variant: "default",
